...
| F2 | Bugs de runtime: loop único, `setMode`, timestep fixo, autosave por projeto, servidor blindado, worker de erosão, codificação | Próxima |
| F3 | Núcleo pequeno com módulos opt-in, ECS com `typeId`, heightfield e contatos, `EffectComposer`, decoders locais | Planejado |
